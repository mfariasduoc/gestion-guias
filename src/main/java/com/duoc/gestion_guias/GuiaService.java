...
public class GuiaService {
    ...
    // Inyectamos el cliente de S3 y el nombre del bucket desde el application.properties
    ...
    public GuiaDespacho crearGuia(GuiaDespacho guia) {
        ...
        try {
            // 1. GUARDAR EN LOCAL (EFS SIMULADO)
            ...
            // Estructura requerida: /anio/transportistaX/guia123.txt
            // Tomamos los primeros 4 dígitos de la fecha para el año (ej: "20260608" -> "2026")
